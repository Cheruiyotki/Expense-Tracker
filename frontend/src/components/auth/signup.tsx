...
export default function SignUp() {
  ...
  const handleSubmit = (e) => {
    ...
    alert("Account created (demo). Replace with real signup flow.");
  };

  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-90 p-6">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <h2 className="text-black text-2xl font-semibold">Create your account</h2>
          <p className="text-sm text-slate-900 mt-2">Start your free trial — no credit card required</p>
        </div>
        ...
        <div className="inset-shadow-sm inset-shadow-blue-700  shadow-xl shadow-blue-700 backdrop-blur-md border border-slate-700 rounded-2xl shadow-xl p-6">
          <form className="space-y-4" onSubmit={handleSubmit} noValidate>
            ...
            <div className="flex items-center justify-between">
              <label className="inline-flex items-center gap-2 text-blue-300">
                <input
                  type="checkbox"
                  checked={acceptTerms}
                  onChange={() => setAcceptTerms((v) => !v)}
                  className="w-4 h-4 rounded border-slate-600 bg-slate-700 focus:ring-blue-500"
                />
                <span className="text-sm text-black">I agree to the <a href="#" className="text-blue-500 hover:underline">Terms</a> and <a href="#" className="text-blue-500 hover:underline">Privacy</a></span>
              </label>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                className="flex items-center justify-center gap-3 px-4 py-2 rounded-md bg-slate-700 border border-slate-700 text-slate-100 hover:bg-slate-600 transition"
              >
                {/* Google icon */}
